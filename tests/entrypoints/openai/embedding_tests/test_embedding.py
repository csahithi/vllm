...
# Use session-scoped embedding_server fixture from conftest
# No need to import - it's automatically available
...
def server(embedding_server):
    # Use session-scoped embedding_server for better performance
